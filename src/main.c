...
int main(void)
{
    ...
    Key_Input_Initialize(KEY1_PORT, KEY1_PIN | KEY2_PIN | KEY3_PIN);
    ...
    while(1)
    {
        if( GPIO_Input_Pin_Data_Get(KEY1_PORT,KEY1_PIN) == PIN_RESET )
				...
				else if( GPIO_Input_Pin_Data_Get(KEY2_PORT,KEY2_PIN) == PIN_RESET )
				{
					Delay(20);
				...
				else if( GPIO_Input_Pin_Data_Get(KEY3_PORT,KEY3_PIN) == PIN_RESET )
				{
					Delay(20);
